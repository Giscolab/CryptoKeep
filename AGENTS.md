...
This project uses project skills in `.Codex/skills/` inspired by Anthropic's defending-code reference workflow:
...
Codex settings and skills are accident guardrails, not a security boundary or sandbox. They do not replace OS/browser isolation or a real audit.
