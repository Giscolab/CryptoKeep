---
description: Orient Codex on Vault Personal and run the first safe security workflow steps.
---

# Quickstart For Vault Personal

Use this skill when the user asks to configure Codex, start a security pass, or understand how to apply the defending-code workflow to this repository.

## Instructions

1. Read `AGENTS.md`, `THREAT_MODEL.md`, `package.json`, and `README.md`.
